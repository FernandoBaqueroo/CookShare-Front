...
function LoginForm({ formData, setFormData, showPassword, setShowPassword, focusedField, setFocusedField, handleSubmit }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-2.5 sm:space-y-3 lg:space-y-3 xl:space-y-4 2xl:space-y-6">
      ...
      <div className="relative group">
        <div className="absolute inset-y-0 left-0 pl-3 sm:pl-3 lg:pl-3 xl:pl-3 2xl:pl-4 flex items-center pointer-events-none">
      ...
      <div className="relative group">
        ...
        <button
          ...
          className="absolute inset-y-0 right-0 pr-3 sm:pr-3 lg:pr-3 xl:pr-3 2xl:pr-4 flex items-center text-pavlova-500 hover:text-pavlova-700"
        >
